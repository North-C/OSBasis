...
gcc-4.4 -m32 -I lib/kernel/ -I lib/ -I kernel/ -c -fno-builtin -o build/interrupt.o \
            kernel/interrupt.c
gcc-4.4 -m32 -I lib/kernel/ -I lib/ -I kernel/ -c -fno-builtin -o build/init.o kernel/init.c
gcc-4.4 -m32 -I lib/kernel/ -c -fno-builtin -o build/timer.o device/timer.c

ld -m elf_i386 -Ttext 0xc0001500 -e main -o build/kernel.bin build/main.o \
            build/init.o build/interrupt.o build/print.o build/kernel.o build/timer.o
